...
def source_fingerprint():
    ...
    root = PROJECT_ROOT
    names = ['fetex/core/config.py', 'fetex/runtime/passenger_manager.py', 'fetex/runtime/passenger_spawn_manager.py',
             'fetex/runtime/taxi_manager.py', 'fetex/runtime/measure_wait_time.py', 'fetex/simulation/build_env.py',
             'fetex/dispatch/hungarian_dispatcher.py', 'fetex/dispatch/forecast_dispatcher.py']
