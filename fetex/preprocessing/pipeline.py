...
사용 (CLI):
    ...
    python -m fetex.preprocessing.pipeline --logs a.csv b.csv        # 여러 날 로그를 이어 붙임
코드에서:
...
from fetex.preprocessing.time_series_prep import TimeSeriesPreprocessor, feature_columns, target_columns, to_naive_kst
