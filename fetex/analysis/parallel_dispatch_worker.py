...
from fetex.runtime.measure_wait_time import print_result, run_and_measure
...
def main():
    ...
    sumo_cfg_path = os.path.join(ROOT, "fetex", "simulation", config_dir_name, "simulation.sumocfg")
    meta_path = os.path.join(ROOT, "fetex", "simulation", config_dir_name, "runtime_meta.json")
