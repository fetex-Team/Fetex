...
from fetex.dispatch.category_demand_predictor import CategoryDemandPredictor

SUMO_CFG = os.path.join(PROJECT_ROOT, "fetex", "simulation", "sumo_config", "simulation.sumocfg")
META_PATH = os.path.join(PROJECT_ROOT, "fetex", "simulation", "sumo_config", "runtime_meta.json")
MODEL_OUT = os.path.join(PROJECT_ROOT, "fetex", "dispatch", "rl_reposition_model.zip")
...
def main():
    ...
    checkpoint_cb = CheckpointCallback(
        save_freq=512,
        save_path=os.path.join(PROJECT_ROOT, "fetex", "dispatch", "checkpoints"),
