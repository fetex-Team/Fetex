...
from fetex.core.config import CFG, ROOT, _apply_region_coords
from fetex.geospatial.poi_extractor import CATEGORIES, get_boundary_edges, get_zones
from fetex.geospatial.largest_component_filter import filter_to_largest_scc
...
def create_network_and_routes():
    config_dir = os.path.join(ROOT, "fetex", "simulation", _args.config_dir or "sumo_config")
    ...
    if shared:
        ...
        from fetex.geospatial.real_map_fetch import build_real_map_network
